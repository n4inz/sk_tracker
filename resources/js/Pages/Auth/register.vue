<template>
   <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="border-2 w-1/2 mx-auto px-6 py-12 lg:px-2 rounded-xl shadow-md">
      <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <img class="mx-auto h-24 w-auto" src="https://tracker-study.n4inz.xyz/umpar.png" alt="Your Company">
