         ...
         <div class="container mx-auto p-4">
            <div class="flex flex-col ">
                <div class="flex-1 border-b-2">
                    ...
                    <div ref="messageContainer" class="p-4 flex flex-col overflow-y-auto h-[350px] relative">
                        ...
                        <div ref="laodingSpin" role="status" class="absolute top-[40%] right-[50%]">
